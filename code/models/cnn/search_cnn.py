...
class SearchCNNController(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        if 'lambda_reg' in subcfg:
            self.lambda_reg = float(subcfg['lambda_reg'])
    ...
    def loss(self, X, y):
        ...
        if not hasattr(self, 'lambda_reg'):
        ...
        for id, cell in enumerate(self.net.cells):
            ...
            weights = self.alpha_reduce if cell.reduction else self.alpha_normal
        ...
        return self.criterion(logits, y) + penalty * self.lambda_reg
